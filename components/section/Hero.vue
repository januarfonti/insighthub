    ...
    <div class="container">
      <div class="flex flex-col items-center justify-center gap-4 md:gap-10">
        ...
        <div class="gap-4 flex flex-wrap">
          <NuxtLink to="/login" class="px-4 h-9 md:px-6 md:h-11 flex whitespace-nowrap items-center text-sm rounded-lg bg-white hover:bg-sky-400 transition text-slate-900 font-semibold">Pelajari Lebih Lanjut</NuxtLink>
          <NuxtLink to="/register" class="px-4 h-9 md:px-6 md:h-11 flex whitespace-nowrap items-center text-sm rounded-lg  transition text-white hover:bg-white hover:text-slate-900 font-semibold border border-slate-600">Mulai Isi Survei</NuxtLink>
        </div>
      </div>
    </div>
  </section>
